...
export const EditPlayList = () => {
   ...
   const modPlayList = (action, id) => {
      ...
      var idList = "";
      if (
         playListLayoutIdsStr !== null &&
         playListLayoutIdsStr.toString().includes(",")
      )
         idList = playListLayoutIdsStr.split(",");
      ...
      var newString = JSON.stringify(idList).replace("[", "").replace("]", "");
                     ...
                     if (res1 !== undefined && res1 !== []) {
                        res1.forEach((e) => {
                           if (parseInt(e.id) === parseInt(rest)) {
                              ...
                              if (
                                 e.playListLayoutIdsStr !== undefined &&
                                 e.playListLayoutIdsStr !== ""
                              ) {
                                 setPlayListLayoutIdsStr(
                                    e.playListLayoutIdsStr
                                 );
                              }
                           }
   ...
   return (
      <div className='appBody'>
         <h4>Edit Playlist ID: {playListID}</h4>

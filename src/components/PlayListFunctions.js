...
export const updPlayListLayoutStr = (pListId,newString,theToken) => {
    return axios
        .post(global.config.routerPath + '/playlist/updplaylistls2', {
            pListId: pListId,
            newString: newString,
            token: theToken,
...
export const removePlayList = (id,theToken) => {
    return axios
        .post(global.config.routerPath + '/playlist/removeplaylist2', {
            id:id,
            token: theToken,
...
export const getPlayLists = theToken => {
    return axios
        .post(global.config.routerPath + '/playlist/getplaylist2',{ 
                token: theToken,
...
export const addPlayLists = (pData, theToken) => {
    return axios
        .post(global.config.routerPath + '/playlist/addplaylist2',{
            name: pData.name,
...
export const removeLayout = (id,theToken) => {
    return axios
        .post(global.config.routerPath + '/playlist/removelayout2', {
            id:id,
            token: theToken,
...
export const getLayouts = theToken => {
    return axios
        .post(global.config.routerPath + '/playlist/getlayouts2',{ 
            token: theToken,
...
export const addLayout = (pData,theToken) => {
    return axios
        .post(global.config.routerPath + '/playlist/addlayout2',{
            title: pData.title,
